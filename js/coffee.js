...
class Mocha extends Coffee {
  noOfHotChocolate;
  constructor(size, isDecaf, noOfHotChocolate) {
    super(size, isDecaf);
    this.noOfHotChocolate = noOfHotChocolate;
  }
  description() {
    console.log(`A ${this.size} Mocha with ${this.noOfHotChocolate} much hot chocolate in it.`);
  }
}

let loganMocha = new Mocha("large", false, "half");
